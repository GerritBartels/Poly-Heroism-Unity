    ...
    public class LevelUpMenu : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            amountOfSkillPointsText.text = "You have " + 
                player.GetComponent<PlayerController>().PlayerModel.AttributePoints.ToString() +
                " Skill Point(s)";
        ...
        /// <summary>
        /// <c>IncreaseStrenght</c> is hooked up to the strength's "Add" button which, when clicked,
